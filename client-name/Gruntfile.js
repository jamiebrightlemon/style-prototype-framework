  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/client-name-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/client-name-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build client-name-style-guide.gemspec && mv client-name-style-guide-' + userConfig.client.version + '.gem ../client-name-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install client-name-style-guide-' + userConfig.client.version + '.gem && rm client-name-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
